...
const ContactForm = ({ data, setData }) => {
  ...
  const [referenceContacts, setReferenceContacts] = useState(
    data?.referenceContacts || [
      { name: '', relationship: '', phone: '', email: '', countryCode: countries[0].code },
    ]
  );
          ...
          <div key={index} className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-4 relative">
            <div>
              ...
              <input
                ...
                onBlur={(e) => handleInputChange(type, index, 'name', e.target.value)}
                ref={nameRef}
                placeholder="Name"
            ...
            <div>
              ...
              <input
                ...
                onBlur={(e) => handleInputChange(type, index, 'relationship', e.target.value)}
                ref={relationshipRef}
            ...
            <div className="relative">
              ...
              <div className="flex">
                ...
                <input
                  ...
                  onBlur={(e) => handleInputChange(type, index, 'phone', e.target.value)}
                  ref={phoneRef}
            ...
            {showEmail && (
              <div>
                ...
                <input
                  ...
                  onBlur={(e) => handleInputChange(type, index, 'email', e.target.value)}
                  ref={emailRef}
                  placeholder="E-mail"
                  className="w-full h-[46px] bg-white shadow rounded-lg text-gray-700 text-[18px] font-light tracking-wider pl-3"
                />
